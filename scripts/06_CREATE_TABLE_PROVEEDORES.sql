...
CREATE TABLE IF NOT EXISTS KIOSCO.PROVEEDORES (
  ...
  PRIMARY KEY (ID_PROVEEDOR, CONTACTO_PROVEEDOR_ID_PROVEEDOR, CONTACTO_PROVEEDOR_ID_USUARIO, ESTADOS_ID_ESTADO),
  UNIQUE INDEX RIF_UNIQUE (RIF ASC),
  INDEX fk_PROVEEDORES_CONTACTO_PROVEEDOR1_idx (CONTACTO_PROVEEDOR_ID_PROVEEDOR ASC, CONTACTO_PROVEEDOR_ID_USUARIO ASC),
  INDEX fk_PROVEEDORES_ESTADOS1_idx (ESTADOS_ID_ESTADO ASC),
  CONSTRAINT fk_PROVEEDORES_CONTACTO_PROVEEDOR1
